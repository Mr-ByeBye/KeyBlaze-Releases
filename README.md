...
# 重要
1. 已经使用`C++`搭配`IMGUI`重写了软件!!!
2. ~~软件使用C#编写,如果你的电脑没有.NET运行时环境,打开软件提示你需要下载个什么东西的英文界面,你可以选择不下,直接跳过,然后不使用此软件,如果你选择使用就必须要下载,就像你使用QQ一定要安装VC运行库一样.我原本也想用C++搭配QT来写,但是想了想这么个工具不至于,快速出效果第一.~~
3. 如果你打开软件发现有界面错位的现象,请使用WPF-UI的版本或者使用V2版本.不要问为什么.
